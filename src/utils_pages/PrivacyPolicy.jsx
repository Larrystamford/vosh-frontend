...
export const PrivacyPolicy = () => {
  return (
    <div className="Privacy_body">
      <MetaTags>
        <meta property="fb:app_id" content="778936509719261" />
        ...
        information about how you browse the Site. - “LocalStorage” are data files
        to allow us to save key/value pairs in a web browser. Additionally when
        you make a purchase or attempt to make a purchase through the Site, we
        collect certain information from you, including your name, billing
        address, shipping address, payment information, email address, and phone
        number. We primarily use Stripe as our payment provider. We refer to this
        ...
        Information and Order Information. HOW DO WE USE YOUR PERSONAL
        INFORMATION? We use the Order Information that we collect generally to
        ...
        Information to: Communicate with you; Screen our orders for potential risk
        ...
        to assess the success of our marketing and advertising campaigns). SHARING
        YOUR PERSONAL INFORMATION We share your Personal Information with third
        parties to help us use your Personal Information, as described above. For
        ...
        practices when we see a Do Not Track signal from your browser. YOUR RIGHTS
        ...
        unless and until you ask us to delete this information. CHANGES We may
      ...
      <p>
        ...
        Site. - “LocalStorage” are data files to allow us to save key/value
        pairs in a web browser. Additionally when you make a purchase or attempt
        to make a purchase through the Site, we collect certain information from
        you, including your name, billing address, shipping address, payment
        information, email address, and phone number. We primarily use Stripe as
        our payment provider. We refer to this information as “Order
        ...
        RETENTION When you place an order through the Site, we will maintain
        your Order Information for our records unless and until you ask us to
        delete this information. CHANGES We may update this privacy policy from
