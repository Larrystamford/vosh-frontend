...
import useInstantShouldPrompt from "./useInstantShouldPrompt";

const webInstallPromptedAt = "webInstallPromptedAt";

const useInstantWebInstall = () => {
  const [installPromptEvent, setInstallPromptEvent] = useState();
  const [
    userShouldBePromptedToInstall,
    handleUserSeeingInstallPrompt,
  ] = useInstantShouldPrompt(webInstallPromptedAt);
...
export default useInstantWebInstall;
