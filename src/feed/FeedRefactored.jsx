...
export const FeedRefactored = (props) => {
  ...
  return (
    <div className={displayFeed ? "feed" : "feed_hide"}>
      <Swiper
        className="feed_videos"
        direction={"vertical"}
        slidesPerView={1}
        onSlideChange={() => console.log("slide change")}
        onSwiper={(swiper) => console.log(swiper)}
      >
        <SwiperSlide className="video" style={{ height: "100vh" }}>
          <img
            className="imgPlaceHolder"
            src="https://dciv99su0d7r5.cloudfront.net/1619456464118_ssstiktok_1619456285.mp4first_frame"
          />
        </SwiperSlide>
        <SwiperSlide className="video" style={{ height: "100vh" }}>
          <img
            className="imgPlaceHolder"
            src="https://dciv99su0d7r5.cloudfront.net/1619456285018_ssstiktok_1619456260.mp4first_frame"
          />
        </SwiperSlide>
